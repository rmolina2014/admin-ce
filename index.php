    ...
    <div class="row h-100">
      <div class="col-lg-5 col-12">
        ...
        <div id="auth-left">
          ...
          <img src="./assets/logo/logoce.jpeg" alt="Logo" height="250px" width="250px" />
          </div>
          ...
          <form action="validarIngreso.php" method="post">
            <div class="form-group position-relative has-icon-left mb-4">
              <input type="text" class="form-control form-control-xl" placeholder="Nombre de Usuario" name="usuario"
                required />
          ...
          if (isset($_GET['mensaje'])) { ?>
            <div class="text-center mt-5 text-lg fs-4">
              <div class="alert alert-danger">Error en el Usuario o el Password. </div>
            </div>
            <?php
          }
          ?>
