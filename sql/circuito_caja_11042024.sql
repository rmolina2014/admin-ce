...
/*Table structure for table `alumno_carrera_pagos` */

DROP TABLE IF EXISTS `alumno_carrera_pagos`;

CREATE TABLE `alumno_carrera_pagos` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `alumno_id` int(10) DEFAULT NULL,
  `carrera_id` int(4) DEFAULT NULL,
...
/*Data for the table `alumno_carrera_pagos` */
...
CREATE TABLE `carrera` (
  ...
  `cantidad_cuotas` int(3) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;

/*Data for the table `carrera` */

insert  into `carrera`(`id`,`nombre`,`cantidad_cuotas`) values (1,'Asistente ',NULL),(2,'Tecnico',NULL),(3,'Farmacia',NULL);
