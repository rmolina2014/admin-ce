                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="col-md-8 mb-3">
                            <label>D.N.I </label>
                            <input name="dnialumno" value="<?php echo $dnipersona; ?>" id="dnialumno" class="form-control" type="text" tabindex="1"
                  ...
                  class="btn btn-sm btn-secondary d-inline-flex align-items-center">Buscar D.N.I.</button-->
                    ...
                    <form method="POST" role="form" action="nuevo.php">
                        ...
                        <input type="hidden" value="<?php echo $idpersona; ?>" id="id_persona" name="id_persona">
